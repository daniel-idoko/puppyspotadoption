...
export default function NewPaypal({closePopup,PaymentId,Price,BreederName,PaypalAddress,PuppyName,setAlert,setAlertMessage,setAlertMode, paymentFor }){
                    ...
                    <>
                        ...
                        <div className="inputHolder">
                                <label className="label" style={{display: 'flex', alignItems: 'center', justifyContent: 'start'}}>
                                    <span style={{marginRight:'0.2rem'}}>Payment Option: <span style={{color: '#ff5f70'}}>*</span></span> <span id='live' className="question">?</span>
                                    <span className="tooltipPopup">To avoid extra fees and ensure the full amount goes directly to the recipient</span>
                                </label>

                                <Grid container style={{justifyContent: 'space-between', alignItems: 'center'}}>
                                    <Grid item xs={10.5}>
                                        <input className="input" defaultValue="Family & Friend" readOnly/>
                                    </Grid>
                        ...
                        <div className="inputHolder">
                                <label className="label">{paymentFor == "adoption" ? "Breeder's" : paymentFor == "transport" ? "Courier's" : null } Paypal Address:</label>
